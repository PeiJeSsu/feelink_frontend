 ...
 */
export const generateCanvasPreview = async (canvas, format, transparentBg) => {
	if (!canvas) {
 ...
 */
export const exportCanvasSelection = async (canvas, selection, contentSize, format, transparentBg) => {
	if (!canvas) {
		throw new Error("畫布未初始化");
	}
